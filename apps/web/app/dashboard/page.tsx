...
function EmptyState() {
  return (
    <div className="card animate-scale-in flex flex-col items-center justify-center px-6 py-20 text-center">
      ...
      <h2 className="display mb-2 text-2xl font-semibold text-ink">Votre premier projet Studio One commence ici</h2>
      <p className="mb-7 max-w-md text-sm leading-relaxed text-muted">
        Donnez une app en ligne à Studio One, décrivez le parcours en une phrase, et il capture les vrais écrans pour
