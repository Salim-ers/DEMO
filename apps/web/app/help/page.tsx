...
const STEPS = [
  { icon: Camera, name: "Capture", text: "Studio One se connecte à votre app et filme les vrais écrans du parcours décrit." },
...
const FAQ = [
  { q: "Par où commencer ?", a: "Créez un projet, indiquez l'URL de votre app et décrivez le parcours en une phrase. Studio One s'occupe du reste." },
  ...
  return (
    <div className="animate-fade-up mx-auto max-w-3xl">
      <header className="mb-8">
        ...
        <h1 className="display text-3xl font-semibold text-ink">Comment fonctionne Studio One</h1>
