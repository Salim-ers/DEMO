  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "drift-1": { "0%,100%": { transform: "translate(0px,0px) scale(1)" }, "50%": { transform: "translate(36px,28px) scale(1.12)" } },
        "drift-2": { "0%,100%": { transform: "translate(0px,0px) scale(1)" }, "50%": { transform: "translate(-44px,-22px) scale(0.92)" } },
        "drift-3": { "0%,100%": { transform: "translate(0px,0px) scale(1)" }, "50%": { transform: "translate(26px,-30px) scale(1.06)" } },
        "hue-pan": { "0%,100%": { backgroundPosition: "0% 50%" }, "50%": { backgroundPosition: "100% 50%" } },
      },
      animation: {
