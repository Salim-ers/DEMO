...
const VARIANTS: Record<Variant, string> = {
  primary: "bg-accent text-studio font-semibold hover:bg-accent-deep",
  secondary: "bg-surface text-ink border border-hairline hover:border-accent/40 hover:bg-elevated",
