...
/** Top marketing nav — transparent over the hero, frosted/solid on scroll. */
export function LandingNav() {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/new" className="hidden btn-primary px-4 py-2 text-sm sm:inline-flex">
              Créer une démo
            </Link>
            <button
              type="button"
      ...
      {/* Mobile drawer */}
      <div
        className={cn("fixed inset-0 z-[60] md:hidden", drawer ? "pointer-events-auto" : "pointer-events-none")}
        aria-hidden={!drawer}
      >
        <div
        ...
        <div
          className={cn(
            "absolute right-0 top-0 h-full w-[284px] max-w-[86vw] border-l border-hairline bg-canvas px-5 py-7 shadow-soft transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
